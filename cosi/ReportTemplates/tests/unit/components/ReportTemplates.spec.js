...
import ReportTemplates from "../../../store/indexReportTemplates";
...
describe("addons/cosi/ReportTemplates/components/ReportTemplates.vue", () => {
    const
        mockConfigJson = {
            Portalconfig: {
                menu: {
    ...
    beforeEach(() => {
        ...
        store.commit("Tools/ReportTemplates/setActive", true);
    });

    describe("Component DOM", () => {
        it("renders the ReportTemplates", () => {
            const wrapper = shallowMount(ReportTemplatesComponent, {store, localVue});

            // expect(wrapper.find("#tool-file-import").exists()).to.be.true;
        });

        it("do not render the ReportTemplates tool if not active", () => {
            store.commit("Tools/ReportTemplates/setActive", false);
            const wrapper = shallowMount(ReportTemplatesComponent, {store, localVue});
